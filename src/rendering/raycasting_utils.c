...
/*   Updated: 2026/01/30 11:26:43 by amacaull         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	calc_wall_params(t_game *game, t_ray *ray)
{
	...
	ray->draw_start = -ray->line_height / 2 + HEIGHT / 2 + game->player.pitch;
	if (ray->draw_start < 0)
		ray->draw_start = 0;
	ray->draw_end = ray->line_height / 2 + HEIGHT / 2 + game->player.pitch;
